...
class _QRScanScreenState extends State<QRScanScreen> {
  ...
  void _triggerInvalidSimulatedScan() {
    // Generate invalid data for testing failure flows
    const String mockData = '{"examId": "BAD_KEY", "invalid": "data"}';
    _navigateToValidation(mockData);
  }
  @override
            ...
            child: Column(
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  label: const Text("Simulate Valid QR Scan"),
                ...
                OutlinedButton.icon(
                  onPressed: _triggerInvalidSimulatedScan,
                  icon: const Icon(Icons.flash_off_rounded, color: Color(0xFFEF4444)),
                  label: const Text("Simulate Invalid QR Scan"),
